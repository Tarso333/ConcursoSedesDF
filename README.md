...
- [`ROADMAP.md`](./ROADMAP.md) — milestones (M0–M26).
- [`IMPORTER.md`](./IMPORTER.md) — importador universal de editais.
- [`CONTEUDO.md`](./CONTEUDO.md) — cobertura da base de estudo (673 conhecimentos · 361 questões · 212 flashcards nos 5 concursos; IBGE 100% dos tópicos cobertos) e prioridades da próxima carga.
